...
if len(sys.argv) < 3:
    print("Usage: python Merge_Transcription.py <day_folder> <random_number_folder>")
    sys.exit(1)
...
AUDIO_DIR = f"./AudioFiles/{DAY_FOLDER}/{RANDOM_NUMBER_FOLDER}"
MERGED_FILE = f"./AudioFiles/{DAY_FOLDER}/{RANDOM_NUMBER_FOLDER}_Merged_Python.txt"
